...
const LogChannel = require('../Schemas.js/logchannelSchemas');
...
async function sendLog(deletedMessage, embed) {
    const logChannelData = await LogChannel.findOne({ guildId: deletedMessage.guild.id }); 
